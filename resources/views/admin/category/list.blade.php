                            ...
                            <table class="example display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->name_ar }}</td>
                                        <td>{{ $data->name_en }}</td>
                                        <td>@if($data->parent_id == 0) No Parent
                                            @else {{$data->parentName}}
                                            @endif</td>

                                        <td>
                                            <a href="{{ route('list.edit', $data->id ) }}" type="button" class="btn btn-rounded btn-secondary">
                                                <i class="fa fa-pencil color-secondary"></i> </a>
                                        </td>

                                        <td>

                                            <form method="POST" action="{{route('list.destroy', $data->id) }}">
                                                @method('DELETE')
