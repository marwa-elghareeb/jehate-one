        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card button-card">
                    <div class="card-body">
                        <a href="{{ route('employees.create') }}" type="button" class="btn btn-rounded btn-info" style="float: right;">
                                ...
                                <tbody>
                                  ...
                                  <?php $i = 1;?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('employees.edit', $data->id ) }}" type="button" class="btn btn-rounded btn-secondary">
