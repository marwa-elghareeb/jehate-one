        ...
        <div class="row page-titles">
            ...
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Show Events</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card button-card">
                    <div class="card-body">
                        <a href="{{ route('events.create') }}" type="button" class="btn btn-rounded btn-info" style="float: right;">
                            ...
                            <table class="example display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('events.edit', $data->id ) }}" type="button" class="btn btn-rounded btn-secondary">
