        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card button-card">
                    <div class="card-body">
                        <a href="{{ route('pages.create') }}" type="button" class="btn btn-rounded btn-info" style="float: right;">
                                ...
                                <tbody>
                                  ...
                                  <?php $i = 1;?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pages.edit', $data->id ) }}" type="button" class="btn btn-rounded btn-secondary">
                                                <i class="fa fa-pencil color-secondary"></i> </a>
                                        </td>

                                        <td>

                                            <form method="POST" action="{{route('pages.destroy', $data->id) }}">
                                                @method('DELETE')
