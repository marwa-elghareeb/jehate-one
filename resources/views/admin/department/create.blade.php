                ...
                <div class="card forms-card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form role="form" id="myForm" enctype="multipart/form-data" method="post" action="{{ route('departments.store') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 col-form-label text-label">Select Comapny Name </label>
                                    <div class="col-lg-9">
                                        <select class="form-control" name="company_id">
                                            <option class="text-muted" value="0"> Select Comapny Name</option>
